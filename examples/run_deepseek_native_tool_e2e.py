...
def main() -> None:
    ...
    runtime = Runtime(reasoner=LLMReasoner(provider, decision_protocol="native_tools"), capabilities={"add": AddCapability()}, policy=StepLimitPolicy(max_steps=8), state_store=MemStore())
