...
_CASE_ROOT = Path(__file__).resolve().parents[5]  # case-01/ (v0.2 lives 2 levels deeper than v0.1)
...
def _is_caption(line: str) -> bool:
    ...
    if not rest:
        return True  # bare "表5.0.1" caption
...
def resolve_table_caption(corpus: Corpus, table_number: str) -> str | None:
    ...
    table_number may be "5.0.4" or "4.4.10". Matching is by normalized caption
