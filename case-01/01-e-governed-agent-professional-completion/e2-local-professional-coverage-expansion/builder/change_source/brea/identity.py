"""Agent identity / version / purpose — E2 v0.3-candidate (IMPLEMENTATION-ONLY change).
...
STATE = "CASE 01-E / E2 governed candidate (professional coverage expansion)"
DOMAIN = "Building Regulation / Engineering Construction Standards — architecture_pre_design"
...
# E2 change: FN-04/05/09 now also resolve through brea.coverage (numbered-subitem
# conditional-rule mechanism); decomposition itself UNCHANGED.
