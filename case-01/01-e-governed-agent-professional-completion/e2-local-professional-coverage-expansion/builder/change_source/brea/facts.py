...
E2 (SEAM-01 bounded EXTENDED): adds the professional facts required by the selected
fire-compartment family (GB 55037-2022 第4.3.16条):
...
FACT_VOCABULARY: dict[str, str] = {
    ...
    "vehicle_goods_category": "vehicle/goods fire category (Clause 3.1.3)",
    "adjacent_building_nature": "nature of the adjacent building/place (Clause 3.1.3)",
    # E2 — fire-compartment family facts (GB 55037-2022 4.3.16)
