"""Agent identity / version / purpose — CASE 01 v0.6-candidate.
...
VERSION = "v0.6-candidate"
LINEAGE_PARENT = "case-01.brea@0.5-candidate"
...
# v0.6 keeps the accepted function, seam, and obligation identifiers. Knowledge is
