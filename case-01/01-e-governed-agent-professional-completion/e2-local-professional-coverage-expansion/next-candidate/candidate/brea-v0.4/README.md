# BREA — Building Regulation Evidence Agent · v0.4-candidate

`case-01.brea @ 0.4-candidate` is the product-first Candidate reconstructed from
the accepted v0.2 generalized local-query behavior, the frozen v0.3 professional
coverage lineage, and the F-EXP-03R A' minimum semantic direction.
...
E1 generalized local-query behavior and T-C01/T-C02/T-C03 remain available. The
Candidate uses the existing two SHA-verified local source references; raw regulation
corpus files remain outside the repository. No LLM, dense retrieval, embeddings,
