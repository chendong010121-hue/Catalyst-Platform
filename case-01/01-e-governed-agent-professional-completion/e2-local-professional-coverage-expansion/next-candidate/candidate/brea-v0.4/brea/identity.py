"""Agent identity / version / purpose — CASE 01 v0.4-candidate.
...
LINEAGE_PARENT = "case-01.brea@0.3-candidate"
...
# v0.4 keeps the accepted function, seam, and obligation identifiers. The semantic
