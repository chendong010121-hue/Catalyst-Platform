...
v0.8 adds only the bounded planning facts declared by KR-003:
...
FACT_VOCABULARY: dict[str, str] = {
    ...
    "land_use_nature": "source-defined land-use nature",
    "residential_average_storeys": "numeric residential average storeys",
    "planning_special_area_status": "special-area / separately-determined indicator status",
}
...
FACT_LABELS: dict[str, str] = {
    ...
    "land_use_nature": "用地性质",
    "residential_average_storeys": "住宅平均层数",
    "planning_special_area_status": "特殊区域指标状态",
}
...
def normalize_value(key: str, value: object) -> object:
    if key in {"floor_area_m2", "residential_average_storeys"}:
