"""Agent identity / version / purpose — CASE 01 v0.7-candidate.
...
VERSION = "v0.7-candidate"
LINEAGE_PARENT = "case-01.brea@0.6-candidate"
...
# v0.7 keeps the accepted function, seam, and obligation identifiers. Knowledge is
