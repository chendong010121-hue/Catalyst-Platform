...
def resolve_level(dbj: Corpus, city_class: str, caption: str | None = None) -> str | None:
...
def applicability_for_question(question: str, facts: dict, dbj: Corpus | dict | None) -> dict:
    """Observable applicability chain. Domain meaning; never numeric authority."""
    chain: dict = {"standard_id": None, "reason": [], "level": None}
    matched = match_route(question, facts, dbj)
