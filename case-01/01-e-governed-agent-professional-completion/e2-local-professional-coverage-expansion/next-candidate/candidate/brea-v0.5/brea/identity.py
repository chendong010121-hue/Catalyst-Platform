"""Agent identity / version / purpose — CASE 01 v0.5-candidate.
...
LINEAGE_PARENT = "case-01.brea@0.4-candidate"
...
# v0.5 keeps the accepted function, seam, and obligation identifiers. The semantic
