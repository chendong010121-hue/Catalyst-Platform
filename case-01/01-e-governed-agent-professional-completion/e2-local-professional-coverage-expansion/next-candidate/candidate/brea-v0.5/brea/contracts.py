...
E1 (IMPLEMENTATION-ONLY): `ImplementationMetadata` gains optional
`query_mode`/`standard_id` fields (backward-compatible: defaults preserve the v0.1
to_dict shape for existing consumers).
"""
...
class ImplementationMetadata:
    ...
    generated_at: str
    # E1 backward-compatible extension (defaults preserve v0.1 shape)
    query_mode: str = "QMODE-05"
    standard_id: str | None = None
    professional_trace: dict[str, Any] = field(default_factory=dict)
